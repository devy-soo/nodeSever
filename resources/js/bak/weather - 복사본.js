...
function loadWeatherByAddress(addressObj){
	...
	let smallRegionCode = getRegionCode(addressObj.addressName2, addressObj.addressName3);
	
	smallRegionCode;
	weekTempSetting(smallRegionCode);
	day2Weather(smallRegionCode);
	

	/*
	function getData() {
		new Promise(function(resolve, reject) {
			resolve(smallRegionCode);
		})
		.then(function(result) {
			day2Weather(result);
			weekTempSetting(result);
		})
		.catch(function(err) {
...
// (0)1-2 기온, 날씨
function day2Weather(regionCode){
